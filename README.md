...
```bash
kubectl apply -f https://github.com/marriedcapita/argocd-ephemeral-access/releases/download/<DESIRED_VERSION>/install.yaml
```
    ...
    spec:
      initContainers:
        - name: extension-ephemeral-access
          ...
          - name: EXTENSION_URL
            value: https://github.com/marriedcapita/argocd-ephemeral-access/releases/download/v0.1.0/extension.tar.gz
          - name: EXTENSION_CHECKSUM_URL
            value: https://github.com/marriedcapita/argocd-ephemeral-access/releases/download/v0.1.0/extension_checksums.txt
...
[1]: https://github.com/marriedcapita/argocd-ephemeral-access/releases
[2]: https://github.com/argoproj-labs/argocd-extension-installer
[3]: https://github.com/marriedcapita/argocd-ephemeral-access/blob/main/config/backend/config.yaml
[4]: https://github.com/marriedcapita/argocd-ephemeral-access/blob/main/config/controller/config.yaml
